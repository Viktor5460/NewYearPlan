...
schedule = {
    ...
    "variants": [
        ...
        # 31 декабря
        {
            ...
            "duration": "30 минут",
            "end_time": "16:00",
            "title": "Сбор жильцов и приспешников!",
            "description": "Начинают собираться жители дачи, а также их верные молодые друзья! Отдых после завтрака и смена в домашнюю одежду.",
            "location": "",
            "tv": "-",
            "image": "🐦"
        },
        {
            ...
            "end_time": "16:30",
            "title": "Доклад Вити!",
            "description": "Доклад, подготовленный Витей по курсу \"Численные Методы\". Демонстрируется для интереса отдельных личностей и с целью развлечения. Можно просто чиллить на диванчике после завтрака и слушать умные слова!",
            "location": "",
            "tv": "-",
            "image": "📊"
        },
        {
            ...
            "description": "Небольшой перекус для тех кто плохо позавтракал и уже успел проголодаться, а до ужина еще далеко (фуршет начнется только в 19:00, но еще будет жарка картошки на костре!)",
            "location": "",
            "tv": "-",
            "image": "🥐"
        },
        {
            ...
            "duration": "30 минут",
            "end_time": "17:30",
            "title": "Дед Мороз для самых маленьких!",
            "description": "Это Ваш первый, но не последний шанс за вечер увидеть Дедушку. Он приходит в удовольствие самым маленьким, которые ложатся спать раньше тех, кто читает это! Но Присутствовать вы, конечно же, можете. Главное не спугнуть!",
            "location": "",
            "tv": "-",
            "image": "🎅"
        },
        {
            ...
            "duration": "1 час",
            "end_time": "18:30",
            "title": "Время пошуметь и поваляться!",
            "description": "Вы же не хотите расстроить Дедушку Мороза?! Тогда спускайтесь в зону веселья, где сможете с любой громкостью отрепетировать свой номер для выступления сегодня вечером! Что? Не придумали номер? Все равно идите к нам за получением халявного выступления (стихи про Путина от Тима). Или просто послушайте как страдают остальные. (или скоммуниздите их номер!)",
            "location": "",
            "tv": "-",
            "image": "🎭"
        },
        {
            ...
            "duration": "1.5 часа",
            "end_time": "20:00",
            "title": "Уличные Забавы!",
            "description": "Присоединяйтесь, чтобы получить волшебное удовольствие на улице от чистого снега, дерзких снежков и разведения костра, а может просто прогулки! Вспомните детсво, обжегшись об картошку в фольге или посыпьте соль на хрустящий хлеб. Также возможен чай в стаканах с собой.",
            "location": "",
            "tv": "-",
            "image": "❄️"
        },
        {
            ...
            "duration": "30 минут",
            "end_time": "20:30",
            "title": "Карнавальное волшебство!",
            "description": "Итак, настало время вспомнить, что сегодня еще и Карнавальная ночь? Что, вы не смотрели фильм? Не бойтесь, он еще в программе! Но не стоит сейчас терять время, бегите мыться и преображаться!",
            "location": "",
            "tv": "-",
            "image": "✨"
        },
        {
            ...
            "description": "Начинаем первый просмотр фильма, в эфире Бриллиантовая Рука, вспомните эту замечательную комедию!",
            "location": "",
            "tv": "-",
            "image": "💎"
        },
