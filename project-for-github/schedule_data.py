...
schedule = {
    ...
    "variants": [
        ...
        },
        {
            ...
            "duration": "30 минут",
            "end_time": "17:00",
            "title": "Легкий Перекур!",
            "description": "Небольшой отдых для тех, кто уже успел устать, а до начала вечера еще далеко!",
            "location": "",
            "tv": "-",
            "image": "🥐"
        },
        ...
        },
        {
            ...
            "duration": "1 час",
            "end_time": "23:15",
            "title": "Незаморочная развлекаловка!",
            "description": "Всегда приятно немного отдохнуть и повеселиться! Так присоединяйтесь в отгадывании интересных и забавных заданий все вместе в устном формате возле диванной зоны! Вам необязательно все время присутсвовать, можете отвлекаться и вновь присоединятся, лишь бы было инетерсно!",
            "location": "",
            "tv": "-",
            "image": "🎨"
        },
